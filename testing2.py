...
# %%
INFO = {k: get_feed(v) for k, v in API_ENDPOINTS.items()}
...
# app.layout = html.Div(
#     [dcc.Graph(id="live-map", figure=fig)], style={"width": "50vw", "height": "50vw"}
# )
app.layout = html.Div(
    [
        dcc.Loading(
            id="loading",
            type="default",  # or 'cube', 'circle', etc.
            children=[
                dcc.Graph(
                    id="live-map", figure=fig, style={"width": "50vw", "height": "50vw"}
                )
            ],
        )
    ]
